...
/*
  Determine if the letter grade of the given variable 'score'.
   ...
   If the variable is a 90 or above, console log an 'A', between 80 and 89, console log a 'B',
    between 70 and 79, 'C', between 60 and 69, 'D', and anything 
...
//(Hint: how can you make sure that your code works for exactly 7 elements? What index do you use to get the 
//7th element?)

//Code Here
if(myFavoriteNumbers.length < 7) {
  console.log('there arent enough elements')
